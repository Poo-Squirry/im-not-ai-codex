...
[epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai)의 Codex 플러그인 포트입니다. 원본 공식 repo의 `v1.5.1` taxonomy update 기준으로 만들었고, 공식 README의 `v1.5` 보강 설명과 community port 링크 업데이트까지 반영했습니다.
...
- Last upstream sync: `6ad338b` (README community-port links, no version change)
