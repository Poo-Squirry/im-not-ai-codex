...
- [`quick-rules.md`](skills/humanize-korean/references/quick-rules.md) — v1.6 fast path용 S1/S2 슬림 룰북
...
- [`metrics.py`](skills/humanize-korean/references/metrics.py) + [`baseline.json`](skills/humanize-korean/references/baseline.json) — KatFish/LREAD 정량 점수 레이어
