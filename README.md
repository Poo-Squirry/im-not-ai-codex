...
# Humanize KR for Codex — 한글 AI 티 제거기 v1.5.0

[epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai)의 Codex 플러그인 포트입니다. 원본 공식 repo의 `v1.5.0` 기준으로 만들었고, 공식 README의 `v1.5` 보강 설명까지 반영했습니다.
...
- Latest release: [`v1.5.0`](https://github.com/Poo-Squirry/im-not-ai-codex/releases/tag/v1.5.0)
- Original release: [`epoko77-ai/im-not-ai v1.5.0`](https://github.com/epoko77-ai/im-not-ai/releases/tag/v1.5.0)

## 버전 정책

이 Codex 포트는 원본 `epoko77-ai/im-not-ai`의 버전을 따라갑니다. 예를 들어 원본이 `v1.5.0`이면 이 plugin도 `v1.5.0`로 배포합니다. 나중에 원본이 `v1.5.1`이나 `v1.6.0`으로 올라가면, 원본 변경분을 반영한 뒤 같은 버전으로 새 release를 만듭니다.

즉 `im-not-ai-codex v1.5.0`은 "원본 `im-not-ai v1.5.0`을 Codex plugin 구조로 옮긴 배포판"이라는 뜻입니다. 전체 변경 내역은 [RELEASE_NOTES.md](./RELEASE_NOTES.md)를 참고하세요.
